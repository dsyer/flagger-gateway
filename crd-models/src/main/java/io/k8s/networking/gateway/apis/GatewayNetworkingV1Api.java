...
public class GatewayNetworkingV1Api {
    private ApiClient localVarApiClient;
    private int localHostIndex;
    private String localCustomBaseUrl;

    public GatewayNetworkingV1Api() {
        this(Configuration.getDefaultApiClient());
    }

    public GatewayNetworkingV1Api(ApiClient apiClient) {
    ...
    private okhttp3.Call createNamespacedHTTPRouteCall(String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        ...
        String localVarPath = "/apis/gateway.networking.k8s.io/v1/namespaces/{namespace}/httproutes"
    ...
    private okhttp3.Call createNamespacedHTTPRouteValidateBeforeCall(String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
    ...
    private ApiResponse<V1HTTPRoute> createNamespacedHTTPRouteWithHttpInfo(String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<V1HTTPRoute>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call createNamespacedHTTPRouteAsync(String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIcreateNamespacedHTTPRouteRequest {
        ...
        private final V1HTTPRoute body;
        private String pretty;
        private String dryRun;
        private String fieldManager;
        private String fieldValidation;

        private APIcreateNamespacedHTTPRouteRequest(String namespace, V1HTTPRoute body) {
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = createNamespacedHTTPRouteWithHttpInfo(namespace, body, pretty, dryRun, fieldManager, fieldValidation);
            return localVarResp.getData();
        }

        /**
         * Execute createNamespacedHTTPRoute request with HTTP info returned
         * @return ApiResponse&lt;V1HTTPRoute&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<V1HTTPRoute> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
     ...
     */
    public APIcreateNamespacedHTTPRouteRequest createNamespacedHTTPRoute(String namespace, V1HTTPRoute body) {
    ...
    private okhttp3.Call deleteNamespacedHTTPRouteCall(String name, String namespace, String pretty, String dryRun, Integer gracePeriodSeconds, Boolean orphanDependents, String propagationPolicy, V1DeleteOptions body, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apis/gateway.networking.k8s.io/v1/namespaces/{namespace}/httproutes/{name}"
    ...
    private okhttp3.Call listHTTPRouteForAllNamespacesCall(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apis/gateway.networking.k8s.io/v1/httproutes";
    ...
    private ApiResponse<V1HTTPRouteList> listHTTPRouteForAllNamespacesWithHttpInfo(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch) throws ApiException {
        ...
        Type localVarReturnType = new TypeToken<V1HTTPRouteList>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call listHTTPRouteForAllNamespacesAsync(Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String pretty, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch, final ApiCallback<V1HTTPRouteList> _callback) throws ApiException {
    ...
    public class APIlistHTTPRouteForAllNamespacesRequest {
         ...
         */
        public V1HTTPRouteList execute() throws ApiException {
            ApiResponse<V1HTTPRouteList> localVarResp = listHTTPRouteForAllNamespacesWithHttpInfo(allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, pretty, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, watch);
            return localVarResp.getData();
        }

        /**
         * Execute listHTTPRouteForAllNamespaces request with HTTP info returned
         * @return ApiResponse&lt;V1HTTPRouteList&gt;
         * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
         * @http.response.details
         <table summary="Response Details" border="1">
            <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
         ...
         */
        public ApiResponse<V1HTTPRouteList> executeWithHttpInfo() throws ApiException {
         ...
         */
        public okhttp3.Call executeAsync(final ApiCallback<V1HTTPRouteList> _callback) throws ApiException {
    ...
    private ApiResponse<V1HTTPRouteList> listNamespacedHTTPRouteWithHttpInfo(String namespace, String pretty, Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch) throws ApiException {
    ...
    private okhttp3.Call listNamespacedHTTPRouteAsync(String namespace, String pretty, Boolean allowWatchBookmarks, String _continue, String fieldSelector, String labelSelector, Integer limit, String resourceVersion, String resourceVersionMatch, Boolean sendInitialEvents, Integer timeoutSeconds, Boolean watch, final ApiCallback<V1HTTPRouteList> _callback) throws ApiException {
    ...
    public class APIlistNamespacedHTTPRouteRequest {
         ...
         */
        public V1HTTPRouteList execute() throws ApiException {
            ApiResponse<V1HTTPRouteList> localVarResp = listNamespacedHTTPRouteWithHttpInfo(namespace, pretty, allowWatchBookmarks, _continue, fieldSelector, labelSelector, limit, resourceVersion, resourceVersionMatch, sendInitialEvents, timeoutSeconds, watch);
            return localVarResp.getData();
        }
    ...
    private ApiResponse<V1HTTPRoute> patchNamespacedHTTPRouteWithHttpInfo(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force) throws ApiException {
    ...
    private okhttp3.Call patchNamespacedHTTPRouteAsync(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIpatchNamespacedHTTPRouteRequest {
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = patchNamespacedHTTPRouteWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
            return localVarResp.getData();
        }
    ...
    private okhttp3.Call patchNamespacedHTTPRouteStatusCall(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force, final ApiCallback _callback) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/apis/gateway.networking.k8s.io/v1/namespaces/{namespace}/httproutes/{name}/status"
            .replace("{" + "name" + "}", localVarApiClient.escapeString(name.toString()))
            .replace("{" + "namespace" + "}", localVarApiClient.escapeString(namespace.toString()));
    ...
    private ApiResponse<V1HTTPRoute> patchNamespacedHTTPRouteStatusWithHttpInfo(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force) throws ApiException {
    ...
    private okhttp3.Call patchNamespacedHTTPRouteStatusAsync(String name, String namespace, V1Patch body, String pretty, String dryRun, String fieldManager, String fieldValidation, Boolean force, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIpatchNamespacedHTTPRouteStatusRequest {
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = patchNamespacedHTTPRouteStatusWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation, force);
            return localVarResp.getData();
        }
    ...
    private ApiResponse<V1HTTPRoute> readNamespacedHTTPRouteWithHttpInfo(String name, String namespace, String pretty, String resourceVersion) throws ApiException {
        okhttp3.Call localVarCall = readNamespacedHTTPRouteValidateBeforeCall(name, namespace, pretty, resourceVersion, null);
        Type localVarReturnType = new TypeToken<V1HTTPRoute>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call readNamespacedHTTPRouteAsync(String name, String namespace, String pretty, String resourceVersion, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIreadNamespacedHTTPRouteRequest {
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = readNamespacedHTTPRouteWithHttpInfo(name, namespace, pretty, resourceVersion);
            return localVarResp.getData();
        }
    ...
    private ApiResponse<V1HTTPRoute> readNamespacedHTTPRouteStatusWithHttpInfo(String name, String namespace, String pretty, String resourceVersion) throws ApiException {
        okhttp3.Call localVarCall = readNamespacedHTTPRouteStatusValidateBeforeCall(name, namespace, pretty, resourceVersion, null);
        Type localVarReturnType = new TypeToken<V1HTTPRoute>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    private okhttp3.Call readNamespacedHTTPRouteStatusAsync(String name, String namespace, String pretty, String resourceVersion, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIreadNamespacedHTTPRouteStatusRequest {
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = readNamespacedHTTPRouteStatusWithHttpInfo(name, namespace, pretty, resourceVersion);
            return localVarResp.getData();
        }
    ...
    private okhttp3.Call replaceNamespacedHTTPRouteCall(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceNamespacedHTTPRouteValidateBeforeCall(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
    ...
    private ApiResponse<V1HTTPRoute> replaceNamespacedHTTPRouteWithHttpInfo(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
    ...
    private okhttp3.Call replaceNamespacedHTTPRouteAsync(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIreplaceNamespacedHTTPRouteRequest {
        ...
        private APIreplaceNamespacedHTTPRouteRequest(String name, String namespace, V1HTTPRoute body) {
            this.name = name;
            this.namespace = namespace;
            this.body = body;
        }
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = replaceNamespacedHTTPRouteWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
            return localVarResp.getData();
        }
     ...
     */
    public APIreplaceNamespacedHTTPRouteRequest replaceNamespacedHTTPRoute(String name, String namespace, V1HTTPRoute body) {
        return new APIreplaceNamespacedHTTPRouteRequest(name, namespace, body);
    }
    private okhttp3.Call replaceNamespacedHTTPRouteStatusCall(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        String basePath = null;
        // Operation Servers
        String[] localBasePaths = new String[] {  };
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call replaceNamespacedHTTPRouteStatusValidateBeforeCall(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback _callback) throws ApiException {
        // verify the required parameter 'name' is set
        if (name == null) {
    ...
    private ApiResponse<V1HTTPRoute> replaceNamespacedHTTPRouteStatusWithHttpInfo(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation) throws ApiException {
    ...
    private okhttp3.Call replaceNamespacedHTTPRouteStatusAsync(String name, String namespace, V1HTTPRoute body, String pretty, String dryRun, String fieldManager, String fieldValidation, final ApiCallback<V1HTTPRoute> _callback) throws ApiException {
    ...
    public class APIreplaceNamespacedHTTPRouteStatusRequest {
        ...
        private APIreplaceNamespacedHTTPRouteStatusRequest(String name, String namespace, V1HTTPRoute body) {
            this.name = name;
            this.namespace = namespace;
            this.body = body;
        }
         ...
         */
        public V1HTTPRoute execute() throws ApiException {
            ApiResponse<V1HTTPRoute> localVarResp = replaceNamespacedHTTPRouteStatusWithHttpInfo(name, namespace, body, pretty, dryRun, fieldManager, fieldValidation);
            return localVarResp.getData();
        }
     ...
     */
    public APIreplaceNamespacedHTTPRouteStatusRequest replaceNamespacedHTTPRouteStatus(String name, String namespace, V1HTTPRoute body) {
